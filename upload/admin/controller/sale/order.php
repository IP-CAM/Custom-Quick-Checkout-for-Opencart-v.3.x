	...
	public function getForm() {
		...
		if (!empty($order_info)) {
            ...
            if(isset($order_info['customer_id']) && $order_info['customer_id'] != '0') {
                ...
                $legal_entities = $this->model_extension_module_legal_entities_nik->getLegalEntitiesInfo($order_info['customer_id']);

                $data['vat'] = $legal_entities['vat'];
                $data['legal_entity_form'] = $legal_entities['legal_entity_form'];
                $data['index'] = $legal_entities['index'];
                $data['inn'] = $legal_entities['inn'];
                $data['kpp'] = $legal_entities['kpp'];
                $data['current_account_number'] = $legal_entities['current_account_number'];
                $data['bank_correspondent_account'] = $legal_entities['bank_correspondent_account'];
                $data['bank_name'] = $legal_entities['bank_name'];
                $data['bic'] = $legal_entities['bic'];
                $data['organization'] = $legal_entities['organization'];
                $data['legal_address'] = $legal_entities['legal_address'];
                $data['mailing_address'] = $legal_entities['mailing_address'];
                $data['head_fullname'] = $legal_entities['head_fullname'];
                $data['business_registration'] = $legal_entities['business_registration'];
            }
	...
	public function info() {
		...
		if ($order_info) {
			...
			if(isset($order_info['customer_id']) && $order_info['customer_id'] != '0') {
			    ...
			    $data['legal_entities'] = $this->model_extension_module_legal_entities_nik->getLegalEntitiesInfo($order_info['customer_id']);
            }
