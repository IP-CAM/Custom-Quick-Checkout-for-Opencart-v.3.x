			...
			if ($this->request->post['payment_address'] == 'new') {
				...
				if (!$json) {
                    ...
                    if (isset($this->request->post['bank_correspondent_account'])){
                        $this->session->data['payment_address']['bank_correspondent_account'] = $this->request->post['bank_correspondent_account'];
                    }
                    if (isset($this->request->post['bank_name'])){
                        $this->session->data['payment_address']['bank_name'] = $this->request->post['bank_name'];
                    }
                    if (isset($this->request->post['bic'])){
                        $this->session->data['payment_address']['bic'] = $this->request->post['bic'];
                    }
                    if (isset($this->request->post['business_registration'])){
                        $this->session->data['payment_address']['business_registration'] = $this->request->post['business_registration'];
                    }
                    if (isset($this->request->post['current_account_number'])){
                        $this->session->data['payment_address']['current_account_number'] = $this->request->post['current_account_number'];
                    }
                    if (isset($this->request->post['head_fullname'])){
                        $this->session->data['payment_address']['head_fullname'] = $this->request->post['head_fullname'];
                    }
                    if (isset($this->request->post['index'])){
                        $this->session->data['payment_address']['index'] = $this->request->post['index'];
                    }
                    if (isset($this->request->post['inn'])){
                        $this->session->data['payment_address']['inn'] = $this->request->post['inn'];
                    }
                    if (isset($this->request->post['kpp'])){
                        $this->session->data['payment_address']['kpp'] = $this->request->post['kpp'];
                    }
                    if (isset($this->request->post['legal_address'])){
                        $this->session->data['payment_address']['legal_address'] = $this->request->post['legal_address'];
                    }
                    if (isset($this->request->post['legal_entity_form'])){
                        $this->session->data['payment_address']['legal_entity_form'] = $this->request->post['legal_entity_form'];
                    }
                    if (isset($this->request->post['mailing_address'])){
                        $this->session->data['payment_address']['mailing_address'] = $this->request->post['mailing_address'];
                    }
                    if (isset($this->request->post['organization'])){
                        $this->session->data['payment_address']['organization'] = $this->request->post['organization'];
                    }
                    if (isset($this->request->post['vat'])){
                        $this->session->data['payment_address']['vat'] = $this->request->post['vat'];
                    }
