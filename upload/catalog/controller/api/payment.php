		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (!$json) {
				...
				$this->session->data['payment_address'] = array(
                    ...
                    'legal_entity_form' => $this->request->post['legal_entity_form'],
                    'organization'   => $this->request->post['organization'],
                    'index'          => $this->request->post['index'],
                    'legal_address'  => $this->request->post['legal_address'],
                    'mailing_address'=> $this->request->post['mailing_address'],
                    'inn'            => $this->request->post['inn'],
                    'kpp'            => $this->request->post['kpp'],
                    'current_account_number' => $this->request->post['current_account_number'],
                    'bank_name'      => $this->request->post['bank_name'],
                    'bic'            => $this->request->post['bic'],
                    'bank_correspondent_account' => $this->request->post['bank_correspondent_account'],
                    'head_fullname'  => $this->request->post['head_fullname'],
                    'business_registration' => $this->request->post['business_registration'],
				);
