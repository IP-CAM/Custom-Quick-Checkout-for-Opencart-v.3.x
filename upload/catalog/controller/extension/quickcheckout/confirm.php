	...
	public function index() {
		...
		if (!$redirect) {
			...
			if ($this->customer->isLogged()) {
                ...
                $legal_entities_info['customer_id'] = $this->customer->getId();
                ...
                $legal_entities_info['customer_id'] = 0;
...
//            $legal_entities_info['email'] = $this->session->data['payment_address']['email'];
            ...
            $this->model_checkout_legal_entities_nik->addLegalEntitiesInfo($legal_entities_info);
